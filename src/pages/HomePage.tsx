    ...
    <>
      ...
      <section className="relative w-full h-[80vh] flex items-center justify-center p-6 ">
        ...
        <div className="relative text-center text-black z-10">
          ...
          >
            <Link to="/products" className="bg-[#004d66] text-white px-4 py-3 rounded-md text-lg font-semibold hover:bg-teal-700 transition-colors shadow-lg">
              Shop Now
            </Link>
            <a href="/#contact" className="bg-white text-[#004d66] px-4 py-3 rounded-md text-lg font-semibold hover:bg-gray-200 transition-colors shadow-lg border border-gray-300">
              Contact us
            </a>
          </motion.div>
        </div>
      ...
      {/* Services Section */}
      <section id="services" className="py-16 px-6 md:px-20 max-w-full bg-gray-50">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
          {services.map((service, index) => (
            ...
            >
              <h3 className="text-lg font-semibold mb-2 text-[#004d66]">{service.title}</h3>
      ...
      <section id="featured-products" className="py-16 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {loading ? (
            <div className="col-span-1 md:col-span-3 text-center py-10">
              <svg className="animate-spin h-10 w-10 text-[#004d66] mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            featured.map((product) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 mb-4">{product.description || "A high-quality product from Smart Lan."}</p>
        ...
        <div className="text-center mt-8">
          <Link to="/products" className="inline-block bg-[#004d66] text-white px-6 py-3 rounded-sm hover:bg-teal-700 transition-colors">
            View All Products
          </Link>
        </div>
      </section>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 px-6 flex flex-col items-center min-w-full bg-gray-50">
        <h2 className="text-3xl font-bold text-center text-[#004d66] mb-10">
          Contact Us
        </h2>
        <ContactForm />
